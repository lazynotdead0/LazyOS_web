...
function onVolumeSliderRelease() {
  playmusic("lazyos_data/ui/Effect_Tick.ogg", volume_click_volume);
}
...
function icon_originos() {
  ...
  setIconAndBackgroundGradient("box1", "lazyos_data/system_calculator.png");
  setIconAndBackgroundGradient("box2", "lazyos_data/system_filemanager.png");
  setIconAndBackgroundGradient("box3", "lazyos_data/system_music.png");
  setIconAndBackgroundGradient("box4", "lazyos_data/system_settings.png");
  setIconAndBackgroundGradient("box5", "lazyos_data/system_messages.png");
  setIconAndBackgroundGradient("box6", "lazyos_data/system_photos.png");
  setIconAndBackgroundGradient("box7", "lazyos_data/system_calendar.png");
  setIconAndBackgroundGradient("box8", "lazyos_data/system_dialer.png");
  setIconAndBackgroundGradient("box9", "lazyos_data/system_clock.png");
  setIconAndBackgroundGradient("box10", "lazyos_data/system_compass.png");
  slider.value = 20;
  value = slider.value;
...
function icon_hyperos() {
  ...
  setIconAndBackgroundGradient2(
    "box1",
    "lazyos_data/iconPacks/hype_icon/system_calculator.png"
  );
  setIconAndBackgroundGradient2(
    "box2",
    "lazyos_data/iconPacks/hype_icon/system_filemanager.png"
  );
  setIconAndBackgroundGradient2(
    "box3",
    "lazyos_data/iconPacks/hype_icon/system_music.png"
  );
  setIconAndBackgroundGradient2(
    "box4",
    "lazyos_data/iconPacks/hype_icon/system_settings.png"
  );
  setIconAndBackgroundGradient2(
    "box5",
    "lazyos_data/iconPacks/hype_icon/system_messages.png"
  );
  setIconAndBackgroundGradient2(
    "box6",
    "lazyos_data/iconPacks/hype_icon/system_photos.png"
  );
  setIconAndBackgroundGradient2(
    "box7",
    "lazyos_data/iconPacks/hype_icon/system_calendar.png"
  );
  setIconAndBackgroundGradient2(
    "box8",
    "lazyos_data/iconPacks/hype_icon/system_dialer.png"
  );
  setIconAndBackgroundGradient2(
    "box9",
    "lazyos_data/iconPacks/hype_icon/system_clock.png"
  );
  setIconAndBackgroundGradient2(
    "box10",
    "lazyos_data/iconPacks/hype_icon/system_compass.png"
  );
  slider.value = 20;
  value = slider.value;
  preview.style.borderRadius = `${value}px`;
...
function icon_ios(e) {
  ...
  setIconAndBackgroundGradient(
    "box1",
    "lazyos_data/iconPacks/i_icon/calculator.png"
  );
  setIconAndBackgroundGradient(
    "box2",
    "lazyos_data/iconPacks/i_icon/files.png"
  );
  setIconAndBackgroundGradient(
    "box3",
    "lazyos_data/iconPacks/i_icon/music.png"
  );
  setIconAndBackgroundGradient(
    "box4",
    "lazyos_data/iconPacks/i_icon/settings.png"
  );
  setIconAndBackgroundGradient(
    "box5",
    "lazyos_data/iconPacks/i_icon/messages.png"
  );
  setIconAndBackgroundGradient(
    "box6",
    "lazyos_data/iconPacks/i_icon/gallery.png"
  );
  setIconAndBackgroundGradient(
    "box7",
    "lazyos_data/iconPacks/i_icon/calendar.png"
  );
  setIconAndBackgroundGradient(
    "box8",
    "lazyos_data/iconPacks/i_icon/phone.png"
  );
  setIconAndBackgroundGradient(
    "box9",
    "lazyos_data/iconPacks/i_icon/clock.png"
  );
  setIconAndBackgroundGradient(
    "box10",
    "lazyos_data/iconPacks/i_icon/compass.png"
  );
  slider.value = 20;
  value = slider.value;
  preview.style.borderRadius = `${value}px`;
...
function icon_coloros() {
  ...
  setIconAndBackgroundGradient(
    "box1",
    "lazyos_data/iconPacks/o_icon/calculator.png"
  );
  setIconAndBackgroundGradient(
    "box2",
    "lazyos_data/iconPacks/o_icon/files.png"
  );
  setIconAndBackgroundGradient(
    "box3",
    "lazyos_data/iconPacks/o_icon/music.png"
  );
  setIconAndBackgroundGradient(
    "box4",
    "lazyos_data/iconPacks/o_icon/settings.png"
  );
  setIconAndBackgroundGradient(
    "box5",
    "lazyos_data/iconPacks/o_icon/messages.png"
  );
  setIconAndBackgroundGradient(
    "box6",
    "lazyos_data/iconPacks/o_icon/gallery.png"
  );
  setIconAndBackgroundGradient(
    "box7",
    "lazyos_data/iconPacks/o_icon/calendar.png"
  );
  setIconAndBackgroundGradient(
    "box8",
    "lazyos_data/iconPacks/o_icon/phone.png"
  );
  setIconAndBackgroundGradient(
    "box9",
    "lazyos_data/iconPacks/o_icon/clock.png"
  );
  setIconAndBackgroundGradient(
    "box10",
    "lazyos_data/iconPacks/o_icon/compass.png"
  );
  slider.value = 20;
  value = slider.value;
  preview.style.borderRadius = `${value}px`;
...
function icon_oneui() {
  ...
  box1.style.setProperty(
    "--bg--originos",
    `url("lazyos_data/iconPacks/oui_icon/calculator.png")`
  );
  box1.style.background = "#00000000";

  box2.style.setProperty(
    "--bg--originos",
    `url("lazyos_data/iconPacks/oui_icon/files.png")`
  );
  box2.style.background = "#00000000";

  box3.style.setProperty(
    "--bg--originos",
    `url("lazyos_data/iconPacks/oui_icon/music.png")`
  );
  box3.style.background = "#00000000";

  box4.style.setProperty(
    "--bg--originos",
    `url("lazyos_data/iconPacks/oui_icon/settings.png")`
  );
  box4.style.background = "#00000000";

  box5.style.setProperty(
    "--bg--originos",
    `url("lazyos_data/iconPacks/oui_icon/messages.png")`
  );
  box5.style.background = "#00000000";

  box6.style.setProperty(
    "--bg--originos",
    `url("lazyos_data/iconPacks/oui_icon/gallery.png")`
  );
  box6.style.background = "#00000000";

  box7.style.setProperty(
    "--bg--originos",
    `url("lazyos_data/iconPacks/oui_icon/calendar.png")`
  );
  box7.style.background = "#00000000";

  box8.style.setProperty(
    "--bg--originos",
    `url("lazyos_data/iconPacks/oui_icon/phone.png")`
  );
  box8.style.background = "#00000000";

  setIconAndBackgroundGradient(
    "box9",
    "lazyos_data/iconPacks/oui_icon/clock.png"
  );
  setIconAndBackgroundGradient(
    "box10",
    "lazyos_data/iconPacks/oui_icon/compass.png"
  );
...
function icon_harmonyos() {
  ...
  setIconAndBackgroundGradient(
    "box1",
    "lazyos_data/iconPacks/harmonyos_icon/calculator.png"
  );
  setIconAndBackgroundGradient(
    "box2",
    "lazyos_data/iconPacks/harmonyos_icon/files.png"
  );
  setIconAndBackgroundGradient(
    "box3",
    "lazyos_data/iconPacks/harmonyos_icon/music.png"
  );
  setIconAndBackgroundGradient(
    "box4",
    "lazyos_data/iconPacks/harmonyos_icon/settings.png"
  );
  setIconAndBackgroundGradient(
    "box5",
    "lazyos_data/iconPacks/harmonyos_icon/messages.png"
  );
  setIconAndBackgroundGradient(
    "box6",
    "lazyos_data/iconPacks/harmonyos_icon/gallery.png"
  );
  setIconAndBackgroundGradient(
    "box7",
    "lazyos_data/iconPacks/harmonyos_icon/calendar.png"
  );
  setIconAndBackgroundGradient(
    "box8",
    "lazyos_data/iconPacks/harmonyos_icon/phone.png"
  );
  setIconAndBackgroundGradient(
    "box9",
    "lazyos_data/iconPacks/harmonyos_icon/clock.png"
  );
  setIconAndBackgroundGradient(
    "box10",
    "lazyos_data/iconPacks/harmonyos_icon/compass.png"
  );
  slider.value = 20;
  value = slider.value;
  preview.style.borderRadius = `${value}px`;
...
function icon_ios26_light1() {
  ...
  setIconAndBackgroundGradient(
    "box1",
    "lazyos_data/iconPacks/i26Light1/calculator.png"
  );
  setIconAndBackgroundGradient(
    "box2",
    "lazyos_data/iconPacks/i26Light1/files.png"
  );
  setIconAndBackgroundGradient(
    "box3",
    "lazyos_data/iconPacks/i26Light1/music.png"
  );
  setIconAndBackgroundGradient(
    "box4",
    "lazyos_data/iconPacks/i26Light1/settings.png"
  );
  setIconAndBackgroundGradient(
    "box5",
    "lazyos_data/iconPacks/i26Light1/messages.png"
  );
  setIconAndBackgroundGradient(
    "box6",
    "lazyos_data/iconPacks/i26Light1/gallery.png"
  );
  setIconAndBackgroundGradient(
    "box7",
    "lazyos_data/iconPacks/i26Light1/calendar.png"
  );
  setIconAndBackgroundGradient(
    "box8",
    "lazyos_data/iconPacks/i26Light1/phone.png"
  );
  setIconAndBackgroundGradient(
    "box9",
    "lazyos_data/iconPacks/i26Light1/clock.png"
  );
  setIconAndBackgroundGradient(
    "box10",
    "lazyos_data/iconPacks/i26Light1/compass.png"
  );
  slider.value = 20;
  value = slider.value;
  preview.style.borderRadius = `${value}px`;
...
function icon_ios26_light2() {
  ...
  box1.style.setProperty(
    "--bg--originos",
    `url("lazyos_data/iconPacks/i26Light2/calculator.png")`
  );
  box1.style.background = "#00000000";

  box2.style.setProperty(
    "--bg--originos",
    `url("lazyos_data/iconPacks/i26Light2/files.png")`
  );
  box2.style.background = "#00000000";

  box3.style.setProperty(
    "--bg--originos",
    `url("lazyos_data/iconPacks/i26Light2/music.png")`
  );
  box3.style.background = "#00000000";

  box4.style.setProperty(
    "--bg--originos",
    `url("lazyos_data/iconPacks/i26Light2/settings.png")`
  );
  box4.style.background = "#00000000";

  box5.style.setProperty(
    "--bg--originos",
    `url("lazyos_data/iconPacks/i26Light2/messages.png")`
  );
  box5.style.background = "#00000000";

  box6.style.setProperty(
    "--bg--originos",
    `url("lazyos_data/iconPacks/i26Light2/gallery.png")`
  );
  box6.style.background = "#00000000";

  box7.style.setProperty(
    "--bg--originos",
    `url("lazyos_data/iconPacks/i26Light2/calendar.png")`
  );
  box7.style.background = "#00000000";

  box8.style.setProperty(
    "--bg--originos",
    `url("lazyos_data/iconPacks/i26Light2/phone.png")`
  );
  box8.style.background = "#00000000";

  box9.style.setProperty(
    "--bg--originos",
    `url("lazyos_data/iconPacks/i26Light2/clock.png")`
  );
  box9.style.background = "#ffffff50";

  box10.style.setProperty(
    "--bg--originos",
    `url("lazyos_data/iconPacks/i26Light2/compass.png")`
  );
...
function icon_pixel() {
  ...
  setIconAndBackgroundGradient(
    "box1",
    "lazyos_data/iconPacks/pix_icon/calculator.png"
  );
  setIconAndBackgroundGradient(
    "box2",
    "lazyos_data/iconPacks/pix_icon/files.png"
  );
  setIconAndBackgroundGradient(
    "box3",
    "lazyos_data/iconPacks/pix_icon/music.png"
  );
  setIconAndBackgroundGradient(
    "box4",
    "lazyos_data/iconPacks/pix_icon/settings.png"
  );
  setIconAndBackgroundGradient(
    "box5",
    "lazyos_data/iconPacks/pix_icon/messages.png"
  );
  setIconAndBackgroundGradient(
    "box6",
    "lazyos_data/iconPacks/pix_icon/gallery.png"
  );
  setIconAndBackgroundGradient(
    "box7",
    "lazyos_data/iconPacks/pix_icon/calendar.png"
  );
  setIconAndBackgroundGradient(
    "box8",
    "lazyos_data/iconPacks/pix_icon/phone.png"
  );
  setIconAndBackgroundGradient(
    "box9",
    "lazyos_data/iconPacks/pix_icon/clock.png"
  );
  setIconAndBackgroundGradient(
    "box10",
    "lazyos_data/iconPacks/pix_icon/compass.png"
  );
  slider.value = 40;
  value = slider.value;
  preview.style.borderRadius = `${value}px`;
...
function icon_nothing() {
  ...
  setIconAndBackgroundGradient(
    "box1",
    "lazyos_data/iconPacks/nothing_icon/calculator.png"
  );
  setIconAndBackgroundGradient(
    "box2",
    "lazyos_data/iconPacks/nothing_icon/files.png"
  );
  setIconAndBackgroundGradient(
    "box3",
    "lazyos_data/iconPacks/nothing_icon/music.png"
  );
  setIconAndBackgroundGradient(
    "box4",
    "lazyos_data/iconPacks/nothing_icon/settings.png"
  );
  setIconAndBackgroundGradient(
    "box5",
    "lazyos_data/iconPacks/nothing_icon/messages.png"
  );
  setIconAndBackgroundGradient(
    "box6",
    "lazyos_data/iconPacks/nothing_icon/gallery.png"
  );
  setIconAndBackgroundGradient(
    "box7",
    "lazyos_data/iconPacks/nothing_icon/calendar.png"
  );
  setIconAndBackgroundGradient(
    "box8",
    "lazyos_data/iconPacks/nothing_icon/phone.png"
  );
  setIconAndBackgroundGradient(
    "box9",
    "lazyos_data/iconPacks/nothing_icon/clock.png"
  );
  setIconAndBackgroundGradient(
    "box10",
    "lazyos_data/iconPacks/nothing_icon/compass.png"
  );
  slider.value = 40;
  value = slider.value;
  preview.style.borderRadius = `${value}px`;

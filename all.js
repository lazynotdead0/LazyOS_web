...
if (
  !dev_name ||
  dev_name.textContent.trim() != "TikTok: @lazynotdead - rn14pro4g"
) {
  localStorage.clear();
...
function lock() {
  ...
  playmusic("lazyos_data/ui/Lock.ogg", volume_unlock_volume);
...
function unlock() {
  ...
  playmusic("lazyos_data/ui/Unlock.ogg", volume_unlock_volume);
...
let animation = lottie.loadAnimation({
  ...
  loop: false,
  autoplay: false,
  path: "lazyos_data/Artboard_1.json",
});
...
const finger_print = lottie.loadAnimation({
  ...
  loop: false,
  autoplay: true,
  path: "lazyos_data/finger_print.json",
});
...
function updateBatteryInfo(battery) {
  ...
  if (battery_level == 20) playmusic("lazyos_data/ui/LowBattery.ogg");
  if (battery_level > 20) battery4.style.background = "white";
  battery_num.textContent = `${battery_level}`;
  if (charging) {
    battery4.style.background = "#26bd44";
    playmusic("lazyos_data/ui/charge_full.ogg", volume_charge_volume);
  }
}
